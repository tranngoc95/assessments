...
class ItemFileRepositoryTest {
    ...
    static final String SEED_PATH = "data/item_test/items-seed.txt";
    static final String TEST_PATH = "data/item_test/items-test.txt";
    ...
    void shouldUpdate() throws DataException {
        Item item = new Item(1, "Ramps", Category.EDIBLE, new BigDecimal("13.3"));;
